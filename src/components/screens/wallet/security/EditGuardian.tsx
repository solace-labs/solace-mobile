...
import {guardianStyles as styles} from '../../../../components/wallet/GuardianSecondTab';
import globalStyles from '../../../../utils/global_styles';
import Entypo from 'react-native-vector-icons/Entypo';
import {Colors} from '../../../../utils/colors';

type EditGuardianScreenProps = NativeStackScreenProps<
...
const EditGuardian = () => {
  ...
  const navigation = useNavigation<EditGuardianScreenProps['navigation']>();
